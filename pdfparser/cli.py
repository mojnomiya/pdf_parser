...
from . import parse_pdf, get_supported_banks, __version__
...
Examples:
  ...
  bank-statement-parser statement.pdf -o metadata.csv transactions.csv
  bank-statement-parser statement.pdf --verbose

Supported Banks: {', '.join(get_supported_banks())}
        """
    )
    ...
    try:
        ...
        # Export to CSV
        metadata_path, transactions_path = parsed_args.output
